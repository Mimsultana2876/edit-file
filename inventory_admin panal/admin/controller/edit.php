...
<?php 
   ...
   //echo $edit_id; 
   //echo (1);
    $show_sql = "SELECT * FROM  catagore_type WHERE cat_type_id ='$edit_id '";
...
<html lang="en">
    ...
    <body>
          ...
          <form class="shadow p-4" >
            ...
            <input  value="<?php echo $show_sql['cat_type_name'];?>"  type="text" id="cat_type_name"  name="cat_type_name" placeholder="cat_type_name" required>
            <?php 
                 if(!empty($error2)){
           ...
           <div class="mb-3">
            ...
            <input value="<?php echo  $show_sql['cat_type_code'];?>"   type="text"       class="cat_type_name" id="cat_type_code" placeholder="cat_type_code" name="cat_type_code" required>
           <?php 
                 if(!empty($error3)){
